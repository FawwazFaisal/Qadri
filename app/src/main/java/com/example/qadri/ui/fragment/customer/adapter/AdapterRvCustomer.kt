package com.example.qadri.ui.fragment.customer.adapter
...
class AdapterRvCustomer (val context: Context?, val listener: ClickListener) :
    RecyclerView.Adapter<AdapterRvCustomer.ViewHolder>() {
