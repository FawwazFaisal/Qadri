package com.example.qadri.location
...
//        userRepository?.uploadUserLocation(arrayListOf<UserLocation>().apply { add(locationDevice) })
        GlobalScope.launch {
...
//    }
    ...
    private fun generateNotification(): Notification {
        ...
        val titleText = getString(com.example.qadri.R.string.app_name)
        ...
        return notificationCompatBuilder
            ...
            .setSmallIcon(com.example.qadri.R.mipmap.ic_qadri_logo)
            .setDefaults(NotificationCompat.DEFAULT_ALL)
            .setOngoing(true)
            .setVisibility(NotificationCompat.VISIBILITY_PUBLIC)
            .addAction(
                com.example.qadri.R.mipmap.ic_qadri_logo,
                getString(com.example.qadri.R.string.launch_activity),
                activityPendingIntent
            )
            .addAction(
                com.example.qadri.R.drawable.ic_close,
